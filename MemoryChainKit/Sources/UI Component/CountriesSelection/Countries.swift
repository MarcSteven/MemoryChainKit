...
//        countries.append(Country(countryCode: "AI", phoneExtension: "1264", isMain: true))
...
//        countries.append(Country(countryCode: "BS", phoneExtension: "1242", isMain: true))
...
//        countries.append(Country(countryCode: "BB", phoneExtension: "1246", isMain: true))
...
//        countries.append(Country(countryCode: "CA", phoneExtension: "1", isMain: true))
...
//        countries.append(Country(countryCode: "GD", phoneExtension: "1809", isMain: true))
//        countries.append(Country(countryCode: "GU", phoneExtension: "1671", isMain: true))
...
//        countries.append(Country(countryCode: "JM", phoneExtension: "1876", isMain: true))
...
//        countries.append(Country(countryCode: "ZW", phoneExtension: "263", isMain: true))
        ...
        let path = Bundle.main.path(forResource: "country_code".localized, ofType: "plist")
        let dict = NSDictionary(contentsOfFile: path!)
        
        let values = Array(dict!.allValues)
        
        for data in values {
            if let vv = data as? Array<Any> {
                for num in vv {
                    if let ww: String = num as? String {
                        if (ww.contains("+")) {
                            var aa: Array = ww.components(separatedBy: "+")
                            if (aa.count >= 2) {
                                countries.append(Country(countryCode: "", phoneExtension: aa[1], isMain: true, countryName: aa[0]))
                            }
                        }
                    }
                }
