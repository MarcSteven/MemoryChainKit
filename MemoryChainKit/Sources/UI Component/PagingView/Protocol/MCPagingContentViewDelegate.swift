//
//  MCPagingContentViewDelegate.swift
//  MemoryChainKit
//
...
public class MCPagingTitleViewConfigure: NSObject  {
    // MARK: MCPagingTitleView 相关属性
    /// MCPagingTitleView 固定样式下，是否需要回弹效果，默认为 false
    @objc public var bounce = false
    
    /// MCPagingTitleView 滚动样式下，是否需要回弹效果，默认为 true
    @objc public var bounces = true
    
    /// MCPagingTitleView 固定样式下标题是否均分布局，默认为 true
    @objc public var equivalence = true
    
    /// MCPagingTitleView 是否显示底部分割线，默认为 true
    @objc public var showBottomSeparator = true
    
    /// MCPagingTitleView 底部分割线颜色，默认为 lightGray
    ...
    /// 指示器距 MCPagingTitleView 底部间的距离，默认为 0.0f
    ...
    @objc public var indicatorScrollStyle: IndicatorScrollableStyle = .Default

    /// 指示器添加在父视图上的层级位置，默认为 Default
    @objc public var indicatorLocation: IndicatorPosition = .Default
    
    
    // MARK: 标题间分割线相关属性
    /// 是否显示标题间分割线，默认为 false
    @objc public var isShowSeparator = false
