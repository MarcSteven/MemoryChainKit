...
/// 扫码区域动画效果
public enum ARIScanViewAnimationStyle {
...
/// 扫码区域4个角位置类型
public enum ARIScanViewPhotoframeAngleStyle {
...
public struct ARIScanViewStyle {
    ...
    //MARK: - 矩形框(扫码区域)周围4个角
    /// 扫码区域的4个角类型
    public var photoframeAngleStyle = ARIScanViewPhotoframeAngleStyle.Outer
    ...
    //MARK: - 动画效果
    /// 扫码动画效果:线条或网格
    public var anmiationStyle = ARIScanViewAnimationStyle.LineMove
