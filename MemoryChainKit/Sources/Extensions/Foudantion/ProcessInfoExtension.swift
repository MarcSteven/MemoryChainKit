...
extension ProcessInfo {
    ...
    fileprivate var inMemoryEnvironmentStorage: [String: String] {
        get {
            return objc_getAssociatedObject(self, &AssociatedKey.inMemoryEnvironmentStorage) as! [String:String]
        }
            
        set {
            return objc_setAssociatedObject(self, &AssociatedKey.inMemoryEnvironmentStorage, newValue, objc_AssociationPolicy.OBJC_ASSOCIATION_COPY_NONATOMIC)
